...
public class Main {
    private static Logger infoLogger, exceptionLogger, warnLogger;
    ...
    public static void main(String[] args) {
        ...
        for (; ; ) {
            try {
                System.out.println("Сгенерировать ошибку? y/n");
                if (scanner.nextLine().equals("y")) throw new IllegalArgumentException("Неверный ввод!");
                ...
                exceptionLogger.error("Ошибка! " + exception);
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
                infoLogger.info("Найдена станция: " + station.getName());
                return station;
            }
            warnLogger.warn("Станция не найдена: " + line);
